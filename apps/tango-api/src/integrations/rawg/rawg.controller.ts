...
@ApiBearerAuth()
@ApiHeader({ name: "x-rawg-admin-key", required: false, description: "Token admin para importaciones RAWG" })
export class RawgController {
  ...
  @ApiBody({ type: ImportBulkDto, examples: { default: { value: { slugs: ["celeste", "the-witcher-3"] } } } })
  ...
  @ApiBody({ type: ImportTopDto, examples: { default: { value: { pages: 5 } } } })
